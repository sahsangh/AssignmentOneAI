...
if __name__ == "__main__":
    ...
    for i in range(50):
        ...
        # path, expanded = repeated_backward_astar(maze, start, goal)
        # expansionValuesLarge.append(expanded)
        # path, expanded = repeated_backward_astar(maze, start, goal, "smaller_g")
        ...
        '''
        path_larger_g, expanded_larger_g = repeated_backward_astar(maze, goal, start, tie_breaking='larger_g')
